...
<div class="easyui-layout" data-options="fit:true">
    <form id="TSysRoleMenuSaveForm" method="post">
        ...
        <div data-options="region:'south',border:false" style="text-align:right;padding:10px;padding-bottom: 5px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
               style="margin-right: 15px " onclick="add_save('TSysRoleMenuSaveForm','tsysrolemenu')">添加</a>
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cut'" href="javascript:void(0)"
               style="margin-right: 15px " onclick="doReset('TSysRoleMenuSaveForm')">重置</a>
        </div>
    </form>
</div>
